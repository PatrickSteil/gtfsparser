...
func NewFeed() *Feed {
	g := Feed{
		...
		Areas:                 make(map[string]*gtfs.Area, 0),
		Networks:              make(map[string]*gtfs.Network, 0),
		Timeframes:            make([]*gtfs.Timeframe, 0),
		FareMedia:             make(map[string]*gtfs.FareMedium, 0),
		FareProducts:          make(map[string][]*gtfs.FareProduct, 0),
		FareLegRules:          make([]*gtfs.FareLegRule, 0),
		FareTransferRules:     make([]*gtfs.FareTransferRule, 0),
